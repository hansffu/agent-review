  ...
  (let* ((review agent-review--review)
    ...
    (magit-insert-section section (agent-review--root-section)
      ...
      (magit-insert-section section (agent-review--metadata-section)
        ...
        (agent-review--insert-labeled-line "Base" (or (alist-get 'base_ref review) "HEAD (working tree)"))
        (agent-review--insert-labeled-line "Head" (or (alist-get 'head_ref review) "uncommitted"))
